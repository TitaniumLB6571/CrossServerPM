...
final class FileSendMessageTask extends FileTask{
	/**
	...
	public function onRun() : void{
		try{
			...
			$this->mutateJson($this->jsonPath($this->networkHash . "-messages-" . $this->targetServerId), function(array &$messages) use ($messageId) : void{
				$messages[$messageId] = [
					"id" => $messageId,
